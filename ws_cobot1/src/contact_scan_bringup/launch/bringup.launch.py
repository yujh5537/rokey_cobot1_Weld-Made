"""자체 노드 5개를 입력원(source)에 맞는 파라미터 파일로 띄운다 (US-07).
  ...
  ros2 launch contact_scan_bringup bringup.launch.py source:=sim          # config/sim.yaml
  ros2 launch contact_scan_bringup bringup.launch.py source:=robot_force  # config/real.yaml
