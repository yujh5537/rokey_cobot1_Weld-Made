...
| 탐침 TCP 오프셋 (최하단점 기준) | **[-1.30, 3.71, 250.21] mm, 자세 [0, 0, 0] deg** (플랜지 기준, 불확도 약 ±1 mm). 아래 구 중심 z에 r을 더했다. 컨트롤러 이름 `rg2_probe_tip` | 2026-09-19 / 학민 (확인: 현지) · `docs/env/tool-tcp-register.md` 3절 |
...
| 홈위치(시작위치) 관절각 | TBD | |
| 탐색 기준점(원점 상공) 높이 | TBD | |
| 팁 반지름 r | **0.45 mm** (인공눈물 용기 끝. 설계 출발값 3 mm를 대체) | 2026-09-19 / 학민 (확인: 현지) |
