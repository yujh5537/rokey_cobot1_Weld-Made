...
환경: 학민 PC `rokey-550XBE-350XBE` / 패키지 버전·커밋: ws_dsr `ahnisinc/cobot_rg2` @ `4d5657f` (`docs/env/versions.md`) / DRCF·DART 버전: Virtual 에뮬레이터 `doosanrobot/dsr_emulator:3.0.1`, DRCF `GF03020000`, DRFL `GL013303` (브링업 로그). **Real 컨트롤러 DRCF `GF02120100`, DRFL `GL013303`** (`sodreal` 로그 118개, `mode : real` · `host 192.168.1.100`, 2026-09-16~21)
