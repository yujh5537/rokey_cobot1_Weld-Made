...
| ROS_DOMAIN_ID | 30 (조 내 분리 필요 시 31~34) | |
...
| DART / DRCF | Virtual 에뮬레이터: DRCF `GF03020000`, DRFL `GL013303`. 실기 컨트롤러: TBD (`sodreal` 로그의 `DRCF version =` 줄) | 2026-09-19 학민 PC, 브링업 로그 |
