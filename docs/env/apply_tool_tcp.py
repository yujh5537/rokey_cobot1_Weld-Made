...
TCP_POS = [-1.30, 3.71, 252.12, 0.0, 0.0, 0.0]  # 2026-09-21 탐침 교체 후 확정(units-frames.md v0.1.11).
# z 는 작업대 기준점(525.19, -172.09) 힘 접촉으로 맞췄다(기준값 100.503, 재확인 100.519).
# x · y 는 2026-09-19 피벗 보정값. 이력: 249.99(9/19) -> 248.52(9/20 밀림) -> 252.12(9/21 교체)
