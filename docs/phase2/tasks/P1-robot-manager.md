...
담당: **현지**(구현, 9/24 학민 → 현지 · D12) · 리뷰: 학민 · 권장 기한: 9/28 (Virtual 통과), 9/29 실기 · 공통 절차: `_common.md`
진행: PR #191(9/24 Virtual line 21 점 통과, spline 폐기 · D31). 아래 초기 설계의 spline 항목은 기록용이다.
